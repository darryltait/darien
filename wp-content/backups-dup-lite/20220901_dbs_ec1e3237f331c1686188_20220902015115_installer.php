...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220901_dbs_ec1e3237f331c1686188_20220902015115_archive.zip';
	const ARCHIVE_SIZE		 = '939916845';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ec1e323-02015115';
    const SECONDARY_PACKAGE_HASH = 'b1ef8a0-02015115';
	const VERSION			 = '1.4.4';
