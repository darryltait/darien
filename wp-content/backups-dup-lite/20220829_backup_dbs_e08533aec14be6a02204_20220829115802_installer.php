...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220829_backup_dbs_e08533aec14be6a02204_20220829115802_archive.zip';
	const ARCHIVE_SIZE		 = '936222077';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'e08533a-29115802';
    const SECONDARY_PACKAGE_HASH = 'ef68b91-29115802';
	const VERSION			 = '1.4.4';
