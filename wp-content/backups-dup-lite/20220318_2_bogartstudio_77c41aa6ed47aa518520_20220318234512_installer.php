...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220318_2_bogartstudio_77c41aa6ed47aa518520_20220318234512_archive.zip';
	const ARCHIVE_SIZE		 = '145901567';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '77c41aa-18234512';
    const SECONDARY_PACKAGE_HASH = '74663ef-18234512';
	const VERSION			 = '1.4.4';
