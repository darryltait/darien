...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220322_2_bogartstudio_1e3745a66ac70c219010_20220322190907_archive.zip';
	const ARCHIVE_SIZE		 = '147483654';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1e3745a-22190907';
    const SECONDARY_PACKAGE_HASH = '16856d0-22190907';
	const VERSION			 = '1.4.4';
