...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220411_2_dbs_backup_f10b383254e55ce82660_20220411211713_archive.zip';
	const ARCHIVE_SIZE		 = '201349241';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f10b383-11211713';
    const SECONDARY_PACKAGE_HASH = '6dc9754-11211713';
	const VERSION			 = '1.4.4';
