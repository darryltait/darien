...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220221_bogartstudio_r2_8913eb2818b0a2ed8171_20220221185503_archive.zip';
	const ARCHIVE_SIZE		 = '63059722';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8913eb2-21185503';
    const SECONDARY_PACKAGE_HASH = '56b691a-21185503';
	const VERSION			 = '1.4.4';
