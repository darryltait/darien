...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220318_bogartstudio_f6925898449fab6d5117_20220318211007_archive.zip';
	const ARCHIVE_SIZE		 = '145901263';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f692589-18211007';
    const SECONDARY_PACKAGE_HASH = '074b313-18211007';
	const VERSION			 = '1.4.4';
