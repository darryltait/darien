...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220411_dbs_backup_9e71f9a278e88af57473_20220411193317_archive.zip';
	const ARCHIVE_SIZE		 = '200927974';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '9e71f9a-11193317';
    const SECONDARY_PACKAGE_HASH = '9a1325f-11193317';
	const VERSION			 = '1.4.4';
