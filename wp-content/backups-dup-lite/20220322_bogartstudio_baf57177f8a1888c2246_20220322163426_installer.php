...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220322_bogartstudio_baf57177f8a1888c2246_20220322163426_archive.zip';
	const ARCHIVE_SIZE		 = '147492057';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'baf5717-22163426';
    const SECONDARY_PACKAGE_HASH = 'ebfdda5-22163426';
	const VERSION			 = '1.4.4';
