...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220413_dbs_backup_37b884903afd9fd48726_20220413204446_archive.zip';
	const ARCHIVE_SIZE		 = '201070918';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '37b8849-13204446';
    const SECONDARY_PACKAGE_HASH = '120b6f9-13204446';
	const VERSION			 = '1.4.4';
