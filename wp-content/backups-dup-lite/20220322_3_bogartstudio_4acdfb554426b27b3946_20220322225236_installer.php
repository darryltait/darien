...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220322_3_bogartstudio_4acdfb554426b27b3946_20220322225236_archive.zip';
	const ARCHIVE_SIZE		 = '147500071';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '4acdfb5-22225236';
    const SECONDARY_PACKAGE_HASH = 'e932444-22225236';
	const VERSION			 = '1.4.4';
