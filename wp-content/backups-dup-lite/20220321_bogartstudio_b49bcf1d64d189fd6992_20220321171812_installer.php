...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220321_bogartstudio_b49bcf1d64d189fd6992_20220321171812_archive.zip';
	const ARCHIVE_SIZE		 = '147437402';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b49bcf1-21171812';
    const SECONDARY_PACKAGE_HASH = '9609201-21171812';
	const VERSION			 = '1.4.4';
