...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220311_bogartstudio_r4backup_e02edad33e1b7d259459_20220311151441_archive.zip';
	const ARCHIVE_SIZE		 = '146423539';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'e02edad-11151441';
    const SECONDARY_PACKAGE_HASH = 'b4d0a8b-11151441';
	const VERSION			 = '1.4.4';
