...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220422_2_dbs_backup_23be745df0837b4e2440_20220422215338_archive.zip';
	const ARCHIVE_SIZE		 = '202593235';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '23be745-22215338';
    const SECONDARY_PACKAGE_HASH = '3741f1e-22215338';
	const VERSION			 = '1.4.4';
