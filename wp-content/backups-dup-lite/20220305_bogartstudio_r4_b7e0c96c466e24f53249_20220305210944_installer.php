...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220305_bogartstudio_r4_b7e0c96c466e24f53249_20220305210944_archive.zip';
	const ARCHIVE_SIZE		 = '128220599';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b7e0c96-05210944';
    const SECONDARY_PACKAGE_HASH = 'd252a93-05210944';
	const VERSION			 = '1.4.4';
