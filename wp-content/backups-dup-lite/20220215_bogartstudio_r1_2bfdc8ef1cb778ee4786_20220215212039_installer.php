...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220215_bogartstudio_r1_2bfdc8ef1cb778ee4786_20220215212039_archive.zip';
	const ARCHIVE_SIZE		 = '60073143';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '2bfdc8e-15212039';
    const SECONDARY_PACKAGE_HASH = 'ca3476a-15212039';
	const VERSION			 = '1.4.4';
