...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220523_dbs_backup_9240b55766df504e9098_20220523200848_archive.zip';
	const ARCHIVE_SIZE		 = '204775354';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '9240b55-23200848';
    const SECONDARY_PACKAGE_HASH = 'eb0954c-23200848';
	const VERSION			 = '1.4.4';
