...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220305_bogartstudio_morningbackup_edb645826575b9798191_20220305184844_archive.zip';
	const ARCHIVE_SIZE		 = '128220208';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'edb6458-05184844';
    const SECONDARY_PACKAGE_HASH = '1b1999a-05184844';
	const VERSION			 = '1.4.4';
