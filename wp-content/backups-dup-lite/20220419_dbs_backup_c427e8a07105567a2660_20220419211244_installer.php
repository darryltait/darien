...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220419_dbs_backup_c427e8a07105567a2660_20220419211244_archive.zip';
	const ARCHIVE_SIZE		 = '201564205';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'c427e8a-19211244';
    const SECONDARY_PACKAGE_HASH = '24cee06-19211244';
	const VERSION			 = '1.4.4';
