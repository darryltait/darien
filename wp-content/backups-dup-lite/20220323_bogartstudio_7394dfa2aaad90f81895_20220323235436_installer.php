...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220323_bogartstudio_7394dfa2aaad90f81895_20220323235436_archive.zip';
	const ARCHIVE_SIZE		 = '147510107';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '7394dfa-23235436';
    const SECONDARY_PACKAGE_HASH = '19b920b-23235436';
	const VERSION			 = '1.4.4';
