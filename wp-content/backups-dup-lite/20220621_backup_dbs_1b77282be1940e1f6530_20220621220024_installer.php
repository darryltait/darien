...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220621_backup_dbs_1b77282be1940e1f6530_20220621220024_archive.zip';
	const ARCHIVE_SIZE		 = '204687311';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1b77282-21220024';
    const SECONDARY_PACKAGE_HASH = 'ab88ff5-21220024';
	const VERSION			 = '1.4.4';
