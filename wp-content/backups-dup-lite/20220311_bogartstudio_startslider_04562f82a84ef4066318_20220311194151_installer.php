...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220311_bogartstudio_startslider_04562f82a84ef4066318_20220311194151_archive.zip';
	const ARCHIVE_SIZE		 = '146422739';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '04562f8-11194151';
    const SECONDARY_PACKAGE_HASH = 'cbd7474-11194151';
	const VERSION			 = '1.4.4';
