...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220401_dbs_backup_wSmush_506225af0d960cae8996_20220401170719_archive.zip';
	const ARCHIVE_SIZE		 = '200664895';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '506225a-01170719';
    const SECONDARY_PACKAGE_HASH = '7966b7a-01170719';
	const VERSION			 = '1.4.4';
