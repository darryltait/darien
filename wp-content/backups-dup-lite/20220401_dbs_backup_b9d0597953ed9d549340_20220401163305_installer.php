...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220401_dbs_backup_b9d0597953ed9d549340_20220401163305_archive.zip';
	const ARCHIVE_SIZE		 = '158053651';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b9d0597-01163305';
    const SECONDARY_PACKAGE_HASH = '78596d8-01163305';
	const VERSION			 = '1.4.4';
