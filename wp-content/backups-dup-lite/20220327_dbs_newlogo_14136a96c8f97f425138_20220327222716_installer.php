...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220327_dbs_newlogo_14136a96c8f97f425138_20220327222716_archive.zip';
	const ARCHIVE_SIZE		 = '156788297';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '14136a9-27222716';
    const SECONDARY_PACKAGE_HASH = '115aac1-27222716';
	const VERSION			 = '1.4.4';
