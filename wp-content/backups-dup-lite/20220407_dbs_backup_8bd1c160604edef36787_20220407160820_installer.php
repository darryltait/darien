...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220407_dbs_backup_8bd1c160604edef36787_20220407160820_archive.zip';
	const ARCHIVE_SIZE		 = '200928909';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8bd1c16-07160820';
    const SECONDARY_PACKAGE_HASH = '7298730-07160820';
	const VERSION			 = '1.4.4';
