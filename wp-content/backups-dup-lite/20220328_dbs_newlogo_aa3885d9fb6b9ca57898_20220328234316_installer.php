...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220328_dbs_newlogo_aa3885d9fb6b9ca57898_20220328234316_archive.zip';
	const ARCHIVE_SIZE		 = '156764672';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'aa3885d-28234316';
    const SECONDARY_PACKAGE_HASH = 'be538e6-28234316';
	const VERSION			 = '1.4.4';
