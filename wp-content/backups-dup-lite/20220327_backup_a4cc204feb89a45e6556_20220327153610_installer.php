...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220327_backup_a4cc204feb89a45e6556_20220327153610_archive.zip';
	const ARCHIVE_SIZE		 = '156693815';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'a4cc204-27153610';
    const SECONDARY_PACKAGE_HASH = 'f4be3e5-27153610';
	const VERSION			 = '1.4.4';
