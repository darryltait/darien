...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220404_dbs_backup_wInhomeArtist_02933738e609975d1306_20220405001316_archive.zip';
	const ARCHIVE_SIZE		 = '201234371';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0293373-05001316';
    const SECONDARY_PACKAGE_HASH = 'db61da3-05001316';
	const VERSION			 = '1.4.4';
