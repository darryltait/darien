...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220414_dbs_backup_12501379ac3917f64995_20220414190509_archive.zip';
	const ARCHIVE_SIZE		 = '201330375';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '1250137-14190509';
    const SECONDARY_PACKAGE_HASH = 'd052304-14190509';
	const VERSION			 = '1.4.4';
