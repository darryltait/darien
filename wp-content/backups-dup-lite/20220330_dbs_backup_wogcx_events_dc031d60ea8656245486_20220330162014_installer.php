...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220330_dbs_backup_wogcx_events_dc031d60ea8656245486_20220330162014_archive.zip';
	const ARCHIVE_SIZE		 = '158053853';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'dc031d6-30162014';
    const SECONDARY_PACKAGE_HASH = 'c3d5d04-30162014';
	const VERSION			 = '1.4.4';
