...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220316_bogartstudio_8761ac8b3fea91f96882_20220317001206_archive.zip';
	const ARCHIVE_SIZE		 = '151783751';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8761ac8-17001206';
    const SECONDARY_PACKAGE_HASH = '31a193f-17001206';
	const VERSION			 = '1.4.4';
